	...
	Paging.prototype = {
		...
		format: function () {
			...
			if (this.pagecount > 6) {
				...
				if (this.current <= 2) {
					html += '<li data-page="2" onclick="dataPage(this)" class="ui-pager">2</li>';
					html += '<li data-page="3" onclick="dataPage(this)" class="ui-pager">3</li>';
					...
					if (this.current > 2 && this.current <= this.pagecount - 2) {
						...
						html += '<li data-page="' + (this.current - 1) + '" onclick="dataPage(this)" class="ui-pager">' + (this.current - 1) + '</li>';
						html += '<li data-page="' + this.current + '" onclick="dataPage(this)" class="ui-pager">' + this.current + '</li>';
						html += '<li data-page="' + (this.current + 1) + '" onclick="dataPage(this)" class="ui-pager">' + (this.current + 1) + '</li>';
						...
						for (var i = this.pagecount - 2; i < this.pagecount; i++) {
							html += '<li data-page="' + i + '" onclick="dataPage(this)" class="ui-pager">' + i + '</li>'
						}
					}
				html += '<li data-page="' + this.pagecount + '" onclick="dataPage(this)" class="ui-pager">' + this.pagecount + '</li>';
			} else {
