...
$.ajax({
    ...
    success: function (data) {
        $.each(data.data, function (key, value) {
            tbody = '<tr><td style="text-indent: 0;text-align: center;">' + value.pid + '</td><td style="text-indent: 100px;">' + value.created_at + '</td><td>' + value.reason + '</td><td>' + value.state + '</td><td>' + '撤销删除' + '</td></tr>';
